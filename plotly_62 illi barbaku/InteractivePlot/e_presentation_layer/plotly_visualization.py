...
class PlotlyCharts:
    ...
    def scatter_with_scanindex(data_records, signal_name):
        ...
        categories = {
            'I': {'name': 'mismatched Values', 'color': 'red', 'opacity': 0.7},
            'O': {'name': 'mismatched Values', 'color': 'red', 'opacity': 0.7},
            'M': {'name': 'Matched Values', 'color': 'blue', 'opacity': 0.2}
        }
    ...
    @staticmethod
    def create_data_comparison_histogram(df, signal_name):
        """
    ...
    @staticmethod
    def create_data_comparison_box(df, signal_name):
        """
