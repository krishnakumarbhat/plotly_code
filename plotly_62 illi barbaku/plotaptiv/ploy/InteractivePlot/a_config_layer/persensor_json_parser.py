"""
JSON parser for PerSensor configuration files.

This module provides functionality to parse JSON input files for per-sensor HDF files.
"""
import os
import json
...
class PersensorJSONParser(IInputOutputParser):
    """Parser for per-sensor JSON configuration files."""
    
    def __init__(self, json_file: str):
        """
        Initialize the PerSensor JSON parser.
    ...
    def get_io_map(self) -> Dict[str, str]:
        ...
        try:
            ...
            # Check for input and output arrays in the JSON (per-sensor format)
