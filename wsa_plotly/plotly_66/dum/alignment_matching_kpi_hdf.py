...
class AlignmentMappingKPIHDF:
    ...
    def __init__(self, input_data: DataModelStorage, output_data: DataModelStorage, 
    ...
    def extract_alignment_data_from_hdf(self, data_model: DataModelStorage):
        """Extract alignment data from HDF DataModelStorage"""
        try:
            alignment_data = {}
...
def process_alignment_kpi(input_data: DataModelStorage, output_data: DataModelStorage, 
                         sensor_id: str, stream_name: str) -> dict:
    """
    Main function to process alignment KPIs from HDF data
    
    Args:
        input_data: DataModelStorage with input/vehicle data
        output_data: DataModelStorage with output/simulation data  
