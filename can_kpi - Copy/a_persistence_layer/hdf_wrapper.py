...
class HdfAttrReader:
    ...
    def extract_detection_signals(self, sensor_data: Dict[str, Any]) -> Dict[str, Dict[int, np.ndarray]]:
        det_groups = sensor_data.get("detection", {})
    ...
    def extract_alignment_signals(self, sensor_data: Dict[str, Any]) -> Dict[str, np.ndarray]:
        return self._extract_flat(sensor_data.get("alignment", {}))

    def extract_header_signals(self, sensor_data: Dict[str, Any]) -> Dict[str, np.ndarray]:
    ...
    def _extract_flat(self, groups: Dict[str, Dict[str, np.ndarray]]) -> Dict[str, np.ndarray]:
        out: Dict[str, np.ndarray] = {}
