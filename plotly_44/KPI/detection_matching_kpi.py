...
class KpiDataModel:
    def __init__(self, input_data, output_data,html_name):
        return None
        # self.create_html(input_data, output_data,html_name)
    def create_html(self,input_data, output_data,html_name):
        """
        ...
        for sig, val in output_data.items():
            # Use sig_val_map_out if needed
            mapped_value = output_data.get(sig, "N/A")
