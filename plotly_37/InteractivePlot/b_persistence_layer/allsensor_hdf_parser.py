        ...
        for index, (input_file, output_file) in enumerate(self.address_map.items()):
            for sensor in sensor_list:
                ...
                with h5py.File(output_file, 'r') as hdf_file_out:
                    ...
                    data_group =  hdf_file_out[f"{sensor}/"]
                    self.data_container_out, self.val_sig_map_out , self.sig_val_map_in = hdf_parser.HDF5Parser.parse(data_group, self.data_container_out,scan_index)
