import os
from InteractivePlot.d_presentation_layer.front_end import html_template, minfy_css ,minfy_js

class HtmlGenerator:
    """Class responsible for generating plots based on fetched data."""
    
    def __init__(self, plots_hash,parent_tabs,kpi_plots,html_name):
