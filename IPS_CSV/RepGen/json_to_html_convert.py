    ...
    def trigger_json_to_html_conversion(self):
        ...
        for sensor in ["FC", "FL", "FR", "RR", "RL"]:
            ...
            if self.is_substring_match_in_longstring("DOWN_SELECTION", json_list_filtered_down_selection):
                self.generate_plotly_html_report_new5(json_list_filtered_down_selection, sensor + "_DOWN_SELECTION_histogram.html")
        ...
        for sensor in ["FC", "FL", "FR", "RR", "RL"]:
            ...
            if self.is_substring_match_in_longstring("DOWN_SELECTION", json_list_filtered_down_selection):
                self.generate_plotly_html_report_new4(json_list_filtered_down_selection, sensor + "_down_selection_scatter.html")
