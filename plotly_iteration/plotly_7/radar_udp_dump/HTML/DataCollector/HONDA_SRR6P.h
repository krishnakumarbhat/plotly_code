#ifndef HONDA_DATACOLLECTOR
#define HONDA_DATACOLLECTOR
...
class HondaSRR6pDataCollector :public IDataCollect
{

public:
	HondaSRR6pDataCollector(std::shared_ptr<PlotParameter[]>& sptr_plotparam);

	virtual ~HondaSRR6pDataCollector();
	...
	void collect_detection_data_honda_srr6p(int fileCount, const char* LogFname, IRadarStream* g_pIRadarStrm,
		short stream_num, unsigned8_T Radar_Posn, Customer_T custId,
		unsigned int scanindex, unsigned int platform, bool IsRECU);

	void collect_mnrblockage_data_honda_srr6p(int fileCount, const char* LogFname, IRadarStream* g_pIRadarStrm,
		short stream_num, unsigned8_T Radar_Posn, Customer_T custId,
		unsigned int scanindex, unsigned int platform, bool IsRECU);

	void collect_tracker_data_honda_srr6p(int fileCount, const char* LogFname, IRadarStream* g_pIRadarStrm,
		short stream_num, unsigned8_T Radar_Posn, Customer_T custId,
		unsigned int scanindex, unsigned int platform, bool IsRECU);

	void collect_alignment_data_honda_srr6p(int fileCount, const char* LogFname, IRadarStream* g_pIRadarStrm,
		short stream_num, unsigned8_T Radar_Posn, Customer_T custId,
		unsigned int scanindex, unsigned int platform, bool IsRECU);

	void CollectLCDA_FF(int fileCount, const char* LogFname, IRadarStream* g_pIRadarStrm,
		short stream_num, unsigned8_T Radar_Posn, Customer_T custId,
		unsigned int scanindex, unsigned int platform);

	void CollectCTA_FF(int fileCount, const char* LogFname, IRadarStream* g_pIRadarStrm,
		short stream_num, unsigned8_T Radar_Posn, Customer_T custId,
		unsigned int scanindex, unsigned int platform);

	void CollectCED_FF(int fileCount, const char* LogFname, IRadarStream* g_pIRadarStrm,
		short stream_num, unsigned8_T Radar_Posn, Customer_T custId,
	    unsigned int scanindex, unsigned int platform);


	std::shared_ptr<PlotParameter[]>& sptr_plotparam_honda_srr6p;
