#ifndef TRATON_DATACOLLECTOR
#define TRATON_DATACOLLECTOR
...
class TratonDataCollector :public IDataCollect
{

public:
	TratonDataCollector(std::shared_ptr<PlotParameter[]>& sptr_plotparam);

	virtual ~TratonDataCollector();
	...
	void collect_detection_data_traton(int fileCount, const char* LogFname, IRadarStream* g_pIRadarStrm,
		short stream_num, unsigned8_T Radar_Posn, Customer_T custId,
	...
	void collect_tracker_data_traton(int fileCount, const char* LogFname, IRadarStream* g_pIRadarStrm,
		short stream_num, unsigned8_T Radar_Posn, Customer_T custId,
		unsigned int scanindex, unsigned int platform, bool IsRECU);

	void collect_alignment_data_traton(int fileCount, const char* LogFname, IRadarStream* g_pIRadarStrm,
		short stream_num, unsigned8_T Radar_Posn, Customer_T custId,
		unsigned int scanindex, unsigned int platform, bool IsRECU);


	std::shared_ptr<PlotParameter[]>& sptr_plotparam_traton;
