#ifndef STLA_SCALE1_DATACOLLECTOR
#define STLA_SCALE1_DATACOLLECTOR
...
class StlaScale1DataCollector:public IDataCollect
{
	
public:
	StlaScale1DataCollector(std::shared_ptr<PlotParameter[]> &sptr_plotparam);
	
	virtual ~StlaScale1DataCollector();
	...
	void collect_v12_vehicle_data_srr6p(int fileCount, const char* LogFname, IRadarStream* g_pIRadarStrm,
										short stream_num, unsigned8_T Radar_Posn, Customer_T custId,
										unsigned int scanindex, unsigned int platform, bool IsRECU);
	...
	void collect_v20_vehicle_data_flr4(int fileCount, const char* LogFname, IRadarStream* g_pIRadarStrm,
								short stream_num, unsigned8_T Radar_Posn, Customer_T custId,
								unsigned int scanindex, unsigned int platform, bool IsRECU);
	...
	void collect_alignment_data_srr6p(int fileCount, const char* LogFname, IRadarStream* g_pIRadarStrm,
										short stream_num, unsigned8_T Radar_Posn, Customer_T custId,
										unsigned int scanindex, unsigned int platform, bool IsRECU);


	void collect_v12_alignment_data_srr6p(int fileCount, const char* LogFname, IRadarStream* g_pIRadarStrm,
										short stream_num, unsigned8_T Radar_Posn, Customer_T custId,
										unsigned int scanindex, unsigned int platform, bool IsRECU);

	void collect_alignment_data_flr4(int fileCount, const char* LogFname, IRadarStream* g_pIRadarStrm,
										short stream_num, unsigned8_T Radar_Posn, Customer_T custId,
										unsigned int scanindex, unsigned int platform, bool IsRECU);


	void collect_mnrblockage_data(int fileCount, const char* LogFname, IRadarStream* g_pIRadarStrm,
									 short stream_num, unsigned8_T Radar_Posn, Customer_T custId,
								    unsigned int scanindex, unsigned int platform, bool IsRECU);

	void collect_v20_alignment_data_flr4(int fileCount, const char* LogFname, IRadarStream* g_pIRadarStrm,
											short stream_num, unsigned8_T Radar_Posn, Customer_T custId,
											unsigned int scanindex, unsigned int platform, bool IsRECU);

	void collect_detection_data_flr4(int fileCount, const char* LogFname, IRadarStream* g_pIRadarStrm,
		                              short stream_num, unsigned8_T Radar_Posn, Customer_T custId,
		                              unsigned int scanindex, unsigned int platform, bool IsRECU);


	void collect_detection_data_flr4p(int fileCount, const char* LogFname, IRadarStream* g_pIRadarStrm,
									short stream_num, unsigned8_T Radar_Posn, Customer_T custId,
									unsigned int scanindex, unsigned int platform, bool IsRECU);


	void collect_tracker_data_flr4p(int fileCount, const char* LogFname, IRadarStream* g_pIRadarStrm,
									short stream_num, unsigned8_T Radar_Posn, Customer_T custId,
									unsigned int scanindex, unsigned int platform, bool IsRECU);

	
	std::shared_ptr<PlotParameter[]>& sptr_plotparam_stla;
