from b_persistence_layer.allsensor_hdf_parser import AllsensorHdfParser
...
class HdfProcessorFactory:
    ...
    The factory supports HDF_WITH_ALLSENSOR format:
    - HDF_WITH_ALLSENSOR - A single HDF file containing data for all sensors
    """
    ...
    def __init__(self, input_output_data, hdf_file_type, output_dir):
        ...
        Parameters:
            input_output_data: Dictionary mapping input file paths to output file paths
            hdf_file_type (str): Type of HDF file format ("HDF_WITH_ALLSENSOR")
