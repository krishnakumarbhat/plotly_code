...
typedef struct All_SCL_Faults_Tag
{
   ...
   Radar_Sensor_Faults_Bit_Fields_T radar_sensor_faults[f360_variant_J::MAX_NUMBER_OF_SENSORS];
   Radar_Sensor_Calib_Faults_Bit_Field_T radar_sensor_calib_faults[f360_variant_J::MAX_NUMBER_OF_SENSORS];
...
typedef struct ROT_Object_List_Info_Tag
{
   ...
   ROT_Object_Output_T rot_object_list[f360_variant_J::NUMBER_OF_REDUCED_OBJECT_TRACKS];
