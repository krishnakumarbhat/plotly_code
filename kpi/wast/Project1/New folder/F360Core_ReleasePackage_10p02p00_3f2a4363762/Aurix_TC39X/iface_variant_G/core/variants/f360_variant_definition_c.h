/*===================================================================================*\
* FILE: f360_variant_definition_c.h
*====================================================================================
...
*
\*==========================================================================================*/
#ifndef F360_VARIANT_DEFINITION_C_H
#define F360_VARIANT_DEFINITION_C_H

#include "f360_reuse.h"
#include "f360_variant_type.h"
namespace f360_variant_C
{
   static constexpr F360_Tracker_Variant_T VARIANT_TYPE = F360_VARIANT_TYPE_C; // Variant type C
   static constexpr uint32_t NUMBER_OF_OBJECT_TRACKS = 250U;
   static constexpr uint32_t NUMBER_OF_REDUCED_OBJECT_TRACKS = 150U;

   static constexpr uint16_t NUMBER_OF_CLUSTERS = 1400U; // maximum number of clusters that can be tracked
   static constexpr uint16_t MAX_NUMBER_OF_HISTORIC_DETECTIONS = 1400U;
