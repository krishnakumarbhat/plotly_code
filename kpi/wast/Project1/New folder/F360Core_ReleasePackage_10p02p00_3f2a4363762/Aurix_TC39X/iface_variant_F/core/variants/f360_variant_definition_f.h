/*===================================================================================*\
* FILE: f360_variant_definition_f.h
*====================================================================================
...
*
\*==========================================================================================*/
#ifndef F360_VARIANT_DEFINITION_F_H
#define F360_VARIANT_DEFINITION_F_H

#include "f360_reuse.h"
#include "f360_variant_type.h"
namespace f360_variant_F
{
   static constexpr F360_Tracker_Variant_T VARIANT_TYPE = F360_VARIANT_TYPE_F;  // Variant type F
