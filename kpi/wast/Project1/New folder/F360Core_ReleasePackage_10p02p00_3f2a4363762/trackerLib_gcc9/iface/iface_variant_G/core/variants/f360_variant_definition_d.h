/*===================================================================================*\
* FILE: f360_variant_definition_d.h
*====================================================================================
...
*
\*==========================================================================================*/
#ifndef F360_VARIANT_DEFINITION_D_H
#define F360_VARIANT_DEFINITION_D_H

#include "f360_reuse.h"
#include "f360_variant_type.h"
namespace f360_variant_D
{
   static constexpr F360_Tracker_Variant_T VARIANT_TYPE = F360_VARIANT_TYPE_D; // Variant type D
   static constexpr uint32_t NUMBER_OF_OBJECT_TRACKS = 250U;
   static constexpr uint32_t NUMBER_OF_REDUCED_OBJECT_TRACKS = 150U;

   static constexpr uint16_t NUMBER_OF_CLUSTERS = 600U; // maximum number of clusters that can be tracked
   static constexpr uint16_t MAX_NUMBER_OF_HISTORIC_DETECTIONS = 600U;
