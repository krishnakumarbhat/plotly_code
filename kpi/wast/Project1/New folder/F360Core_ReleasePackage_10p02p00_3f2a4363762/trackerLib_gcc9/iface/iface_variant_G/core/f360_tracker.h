#ifndef F360_TRACKER_VARIANT_G_H
#define F360_TRACKER_VARIANT_G_H
/*===================================================================================*\
* FILE: f360_tracker.h
*====================================================================================
...
namespace f360_variant_G
{
   ...
   public:
      ...
      virtual void Execute(
         ...
         const rspp_variant_G::RSPP_Detection_List_T& raw_detect_list,
      ...
      static void Log_Detections(F360_Detection_Log_Output_T* const log, const rspp_variant_G::RSPP_Detection_List_T &det_list);
      ...
      static void Fill_ROT_Object_Output(
         const rspp_variant_G::RSPP_Detection_List_T& det_list,
      ...
      void Write_Debug_Info(
         ...
         const rspp_variant_G::RSPP_Detection_List_T* const raw_detect_list,
         const F360_Radar_Sensor_T (&sensors)[MAX_NUMBER_OF_SENSORS],
