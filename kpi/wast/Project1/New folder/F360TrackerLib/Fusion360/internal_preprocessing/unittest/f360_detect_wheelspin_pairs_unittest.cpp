/** \file
 * This file contains unit tests for content of f360_detect_wheelspin_pairs.cpp file
 */
 ...
 */
TEST_GROUP(f360_detect_wheelspin_pairs)
{	
 ...
 */
TEST(f360_detect_wheelspin_pairs, FunctionToTest_Descriptive_Tag)
{
   /** \precond
