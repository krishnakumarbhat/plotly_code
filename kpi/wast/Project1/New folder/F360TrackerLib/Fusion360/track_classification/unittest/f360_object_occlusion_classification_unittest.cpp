/** \file
 * This file contains unit tests for content of f360_object_occlusion_classification.cpp file
 */
 ...
 */
TEST(f360_object_occlusion_classification, FunctionToTest_Descriptive_Tag)
{
   /** \precond
