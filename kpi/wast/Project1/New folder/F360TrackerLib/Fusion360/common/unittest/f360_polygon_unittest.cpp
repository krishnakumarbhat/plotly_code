/** \file
 * This file contains unit tests for content of f360_polygon.cpp file
 */
 ...
 */
TEST(f360_polygon, FunctionToTest_Descriptive_Tag)
{
   /** \precond
