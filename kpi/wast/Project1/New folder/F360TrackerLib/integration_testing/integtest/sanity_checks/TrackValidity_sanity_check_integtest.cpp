...
/** \defgroup  f360_tracker_trackvalidity_sanity_checks
 *  @{
 */
 ...
 **/
TEST_GROUP(f360_tracker_trackvalidity_sanity_checks)
{
 ...
 *\req
 * FTCP-11011 ,FTCP-8691 , FTCP-10878, FTCP-8689
 **/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_host_speed_nominal)
{
   /** \precond
    ...
    **/
    ...
    /** \action
     * Call TrackValidity module function
     **/
...
* FTCP-11011 ,FTCP-8691 , FTCP-10878, FTCP-8689
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_host_speed_max)
{
   /** \precond
...
// *FTCP-11011 ,FTCP-8691 , FTCP-10878, FTCP-8689
// **/
// TEST(f360_tracker_trackvalidity_sanity_checks,TrackValidity_check_verification_of_host_speed_above_max)
// {
   // /** \precond
...
*FTCP-11011 ,FTCP-8691 , FTCP-10878, FTCP-8689
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_host_speed_min)
{
   /** \precond
...
// *FTCP-11011 ,FTCP-8691 , FTCP-10878, FTCP-8689
// **/
// TEST(f360_tracker_trackvalidity_sanity_checks,TrackValidity_check_verification_of_host_speed_below_min)
// {
   // /** \precond
...
*\req
*FTCP-11011 ,FTCP-8691 , FTCP-10878, FTCP-8687
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_host_acceleration_nominal)
{
   /** \precond
...
*FTCP-11011 ,FTCP-8691 , FTCP-10878, FTCP-8687
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_host_acceleration_max)
{
   /** \precond
...
// *FTCP-11011 ,FTCP-8691 , FTCP-10878, FTCP-8687
// **/
// TEST(f360_tracker_trackvalidity_sanity_checks,TrackValidity_check_verification_of_host_acceleration_above_max)
// {
   // /** \precond
...
*FTCP-11011 ,FTCP-8691 , FTCP-10878, FTCP-8687
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_host_acceleration_min)
{
   /** \precond
...
// *FTCP-11011 ,FTCP-8691 , FTCP-10878, FTCP-8687
// **/
// TEST(f360_tracker_trackvalidity_sanity_checks,TrackValidity_check_verification_of_host_acceleration_below_min)
// {
   // /** \precond
...
*\req
*FTCP-11011 ,FTCP-8691 , FTCP-10878, FTCP-8688
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_host_yaw_rate_rad_nominal)
{
   /** \precond
...
*FTCP-11011 ,FTCP-8691 , FTCP-10878, FTCP-8688
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_host_yaw_rate_rad_max)
{
   /** \precond
...
// *FTCP-11011 ,FTCP-8691 , FTCP-10878, FTCP-8688
// **/
// TEST(f360_tracker_trackvalidity_sanity_checks,TrackValidity_check_verification_of_host_yaw_rate_rad_above_max)
// {
   // /** \precond
...
*FTCP-11011 ,FTCP-8691 , FTCP-10878, FTCP-8688
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_host_yaw_rate_rad_min)
{
   /** \precond
...
// *FTCP-11011 ,FTCP-8691 , FTCP-10878, FTCP-8688
// **/
// TEST(f360_tracker_trackvalidity_sanity_checks,TrackValidity_check_verification_of_host_yaw_rate_rad_below_min)
// {
   // /** \precond
   ...
   // Measurement_Update_Tracks(globals, calibrations, host, tracker_info, detections, detection_posn_hist, object_tracks, timing_info);

   // Initialize_Tracks(host, host_props, globals, calibrations, clusters, object_tracks, tracker_info, detections, det_hist, detection_posn_hist, timing_info);

   // Post_Update_Track_Adjustments(calibrations, globals, raw_detection_list, sensors, host, tracker_info, detections, detection_posn_hist, object_tracks, timing_info);

   // Track_Classification(host, host_props, tracker_info, object_tracks, globals, detections, raw_detection_list, underdrivability, sensors, timing_info, calibrations);

   // Track_Validity(host, tracker_info, calibrations, sensors, sensor_props, sensors, object_tracks, guardrails, timing_info);
...
*\req
*FTCP-11011 ,FTCP-8691 , FTCP-10878, FTCP-8686
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_host_curvature_rear_nominal)
{
   /** \precond
...
*FTCP-11011 ,FTCP-8691 , FTCP-10878, FTCP-8686
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_host_curvature_rear_max)
{
   /** \precond
...
// *FTCP-11011 ,FTCP-8691 , FTCP-10878, FTCP-8686
// **/
// TEST(f360_tracker_trackvalidity_sanity_checks,TrackValidity_check_verification_of_host_curvature_rear_above_max)
// {
   // /** \precond
...
*FTCP-11011 ,FTCP-8691 , FTCP-10878, FTCP-8686
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_host_curvature_rear_min)
{
   /** \precond
...
// *FTCP-11011 ,FTCP-8691 , FTCP-10878, FTCP-8686
// **/
// TEST(f360_tracker_trackvalidity_sanity_checks,TrackValidity_check_verification_of_host_curvature_rear_below_min)
// {
   // /** \precond
...
*\req
*FTCP-11011 ,FTCP-8691 , FTCP-10878,FTCP-8684
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_dist_rear_axle_to_vcs_m_nominal)
{
   /** \precond
...
*FTCP-11011 ,FTCP-8691 , FTCP-10878 ,FTCP-8684
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_host_dist_rear_axle_to_vcs_m_max)
{
   /** \precond
...
// *FTCP-11011 ,FTCP-8691 , FTCP-10878,FTCP-8684
// **/
// TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_host_dist_rear_axle_to_vcs_m_above_max)
// {
   // /** \precond
...
*FTCP-11011 ,FTCP-8691 , FTCP-10878, FTCP-8684
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_host_dist_rear_axle_to_vcs_m_min)
{
   /** \precond
...
// *FTCP-11011 ,FTCP-8691 , FTCP-10878, FTCP-8684
// **/
// TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_host_dist_rear_axle_to_vcs_m_below_min)
// {
   // /** \precond
...
*\req
*FTCP-11011 ,FTCP-8704,FTCP-8706
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_id_nominal)
{
   /** \precond
...
*FTCP-11011 ,FTCP-8704,FTCP-8706
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_id_max)
{
   /** \precond
...
// *FTCP-11011 ,FTCP-8704,FTCP-8706
// **/
// TEST(f360_tracker_trackvalidity_sanity_checks,TrackValidity_check_verification_of_sensors_id_above_max)
// {
   // /** \precond
...
*FTCP-11011 ,FTCP-8704,FTCP-8706
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_id_min)
{
   /** \precond
...
// *FTCP-11011 ,FTCP-8704,FTCP-8706
// **/
// TEST(f360_tracker_trackvalidity_sanity_checks,TrackValidity_check_verification_of_sensors_id_below_min)
// {
   // /** \precond
...
*\req
*FTCP-11011 ,FTCP-8704, FTCP-8726
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_sensor_type_correct)
{
   /** \precond
   ...
   CHECK_TEXT(sensors[0].constant.sensor_type == F360_SENSOR_TYPE_MRR3_RADAR, "sensors[0].constant.sensor_type  isn't the correct sensor in correct sensor_type test case");
...
// *FTCP-11011 ,FTCP-8704, FTCP-8726
// **/
// TEST(f360_tracker_trackvalidity_sanity_checks,TrackValidity_check_verification_of_sensors_sensor_type_wrong)
// {
   // /** \precond
   ...
   // CHECK_TEXT(sensors[0].constant.sensor_type  == F360_SENSOR_TYPE_MRR3_RADAR, "sensors[0].constant.sensor_type isn't the correct sensor in sensor_type wrong test case");
...
*\req
*FTCP-11011 ,FTCP-8704, FTCP-8724
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_mounting_location_correct)
{
   /** \precond
   ...
   CHECK_TEXT((sensors[0].constant.mounting_location == F360_MOUNTING_LOCATION_LEFT_FORWARD) ||
      ...
      (sensors[0].constant.mounting_location == F360_MOUNTING_LOCATION_RIGHT_REAR), "sensors[0].constant.mounting_location  isn't the correct value in correct sensor_type test case");
...
// *FTCP-11011 ,FTCP-8704, FTCP-8724
// **/
// TEST(f360_tracker_trackvalidity_sanity_checks,TrackValidity_check_verification_of_sensors_mounting_location_wrong)
// {
   // /** \precond
...
*\req
*FTCP-11011 ,FTCP-8704, FTCP-8725
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_mounting_position_long_nominal)
{
   /** \precond
...
*FTCP-11011 ,FTCP-8704, FTCP-8725
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_mounting_position_long_max)
{
   /** \precond
...
// *FTCP-11011 ,FTCP-8704, FTCP-8725
// **/
// TEST(f360_tracker_trackvalidity_sanity_checks,TrackValidity_check_verification_of_sensors_mounting_position_long_above_max)
// {
   // /** \precond
...
*FTCP-11011 ,FTCP-8704, FTCP-8725
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_mounting_position_long_min)
{
   /** \precond
...
// *FTCP-11011 ,FTCP-8704, FTCP-8725
// **/
// TEST(f360_tracker_trackvalidity_sanity_checks,TrackValidity_check_verification_of_sensors_mounting_position_long_below_min)
// {
   // /** \precond
...
*FTCP-11011 ,FTCP-8704, FTCP-8725
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_mounting_position_lat_nominal)
{
   /** \precond
...
*FTCP-11011 ,FTCP-8704, FTCP-8725
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_mounting_position_lat_max)
{
   /** \precond
...
// *FTCP-11011 ,FTCP-8704, FTCP-8725
// **/
// TEST(f360_tracker_trackvalidity_sanity_checks,TrackValidity_check_verification_of_sensors_mounting_position_lat_above_max)
// {
   // /** \precond
...
*FTCP-11011 ,FTCP-8704, FTCP-8725
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_mounting_position_lat_min)
{
   /** \precond
    set sensors[0].constant.mounting_position  to get min value.
    **/
...
// *FTCP-11011 ,FTCP-8704, FTCP-8725
// **/
// TEST(f360_tracker_trackvalidity_sanity_checks,TrackValidity_check_verification_of_sensors_mounting_position_lat_below_min)
// {
   // /** \precond
...
*FTCP-11011 ,FTCP-8704, FTCP-8725
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_mounting_position_height_nominal)
{
   /** \precond
...
*FTCP-11011 ,FTCP-8704, FTCP-8725
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_mounting_position_height_max)
{
   /** \precond
...
// *FTCP-11011 ,FTCP-8704, FTCP-8725
// **/
// TEST(f360_tracker_trackvalidity_sanity_checks,TrackValidity_check_verification_of_sensors_mounting_position_height_above_max)
// {
   // /** \precond
...
*FTCP-11011 ,FTCP-8704, FTCP-8725
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_mounting_position_height_min)
{
   /** \precond
    set sensors[0].constant.mounting_position  to get min value.
    **/
...
// *FTCP-11011 ,FTCP-8704, FTCP-8725
// **/
// TEST(f360_tracker_trackvalidity_sanity_checks,TrackValidity_check_verification_of_sensors_mounting_position_height_below_min)
// {
   // /** \precond
...
*\req FTCP-11011 ,FTCP-8704, FTCP-8725
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_mounting_position_azimuth_nominal)
{
   /** \precond
...
*FTCP-11011 ,FTCP-8704, FTCP-8725
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_mounting_position_azimuth_max)
{
   /** \precond
...
// *FTCP-11011 ,FTCP-8704, FTCP-8725
// **/
// TEST(f360_tracker_trackvalidity_sanity_checks,TrackValidity_check_verification_of_sensors_mounting_position_azimuth_above_max)
// {
   // /** \precond
...
*FTCP-11011 ,FTCP-8704, FTCP-8725
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_mounting_position_azimuth_min)
{
   /** \precond
...
// *FTCP-11011 ,FTCP-8704, FTCP-8725
// **/
// TEST(f360_tracker_trackvalidity_sanity_checks,TrackValidity_check_verification_of_sensors_mounting_position_azimuth_below_min)
// {
   // /** \precond
...
*FTCP-11011 ,FTCP-8704, FTCP-8725
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_mounting_position_elevation_nominal)
{
   /** \precond
...
*FTCP-11011 ,FTCP-8704, FTCP-8725
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_mounting_position_elevation_max)
{
   /** \precond
    set sensors[0].constant.mounting_position.vcs_boresight_azimuth_angle  to get a  max value.
    **/
...
// *FTCP-11011 ,FTCP-8704, FTCP-8725
// **/
// TEST(f360_tracker_trackvalidity_sanity_checks,TrackValidity_check_verification_of_sensors_mounting_position_elevation_above_max)
// {
   // /** \precond
...
*FTCP-11011 ,FTCP-8704, FTCP-8725
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_mounting_position_elevation_min)
{
   /** \precond
    set sensors[0].constant.mounting_position.vcs_boresight_azimuth_angle  to get min value.
    **/
...
// *FTCP-11011 ,FTCP-8704, FTCP-8725
// **/
// TEST(f360_tracker_trackvalidity_sanity_checks,TrackValidity_check_verification_of_sensors_mounting_position_elevation_below_min)
// {
   // /** \precond
...
*\req
*FTCP-11011 ,FTCP-8704, FTCP-8723
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_polarity_nominal)
{
   /** \precond
...
*FTCP-11011 ,FTCP-8704, FTCP-8723
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_polarity_max)
{
   /** \precond
...
// *FTCP-11011 ,FTCP-8704,FTCP-8723
// **/
// TEST(f360_tracker_trackvalidity_sanity_checks,TrackValidity_check_verification_of_sensors_polarity_above_max)
// {
   // /** \precond
...
*FTCP-11011 ,FTCP-8704,FTCP-8723
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_polarity_min)
{
   /** \precond
...
// *FTCP-11011 ,FTCP-8704,FTCP-8723
// **/
// TEST(f360_tracker_trackvalidity_sanity_checks,TrackValidity_check_verification_of_sensors_polarity_below_min)
// {
   // /** \precond
...
*\req
*FTCP-11011 ,FTCP-8704, FTCP-8721
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_fov_min_az_rad_nominal)
{
   /** \precond
...
*\req FTCP-11011 ,FTCP-8704, FTCP-8721
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_fov_min_az_rad_max)
{
   /** \precond
...
// *FTCP-11011 ,FTCP-8704, FTCP-8721
// **/
// TEST(f360_tracker_trackvalidity_sanity_checks,TrackValidity_check_verification_of_sensors_fov_min_az_rad_above_max)
// {
   // /** \precond
...
*FTCP-11011 ,FTCP-8704, FTCP-8721
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_fov_min_az_rad_min)
{
   /** \precond
...
// *FTCP-11011 ,FTCP-8704, FTCP-8721
// **/
// TEST(f360_tracker_trackvalidity_sanity_checks,TrackValidity_check_verification_of_sensors_fov_min_az_rad_below_min)
// {
   // /** \precond
...
*\req
*FTCP-11011 ,FTCP-8704, FTCP-8720
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_fov_max_az_rad_nominal)
{
   /** \precond
...
*FTCP-11011 ,FTCP-8704, FTCP-8720
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_fov_max_az_rad_max)
{
   /** \precond
...
// *FTCP-11011 ,FTCP-8704, FTCP-8720
// **/
// TEST(f360_tracker_trackvalidity_sanity_checks,TrackValidity_check_verification_of_sensors_fov_max_az_rad_above_max)
// {
   // /** \precond
...
*FTCP-11011 ,FTCP-8704, FTCP-8720
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_fov_max_az_rad_min)
{
   /** \precond
...
// *FTCP-11011 ,FTCP-8704, FTCP-8720
// **/
// TEST(f360_tracker_trackvalidity_sanity_checks,TrackValidity_check_verification_of_sensors_fov_max_az_rad_below_min)
// {
   // /** \precond
...
*\req
*FTCP-11011 ,FTCP-8704, FTCP-8717
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_min_aliaised_range_rate_nominal)
{
   /** \precond
...
*FTCP-11011 ,FTCP-8704, FTCP-8717
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_min_aliaised_range_rate_max)
{
   /** \precond
...
// *FTCP-11011 ,FTCP-8704, FTCP-8717
// **/
// TEST(f360_tracker_trackvalidity_sanity_checks,TrackValidity_check_verification_of_sensors_min_aliaised_range_rate_above_max)
// {
   // /** \precond
...
*FTCP-11011 ,FTCP-8704, FTCP-8717
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_min_aliaised_range_rate_min)
{
   /** \precond
...
// *FTCP-11011 ,FTCP-8704, FTCP-8717
// **/
// TEST(f360_tracker_trackvalidity_sanity_checks,TrackValidity_check_verification_of_sensors_min_aliaised_range_rate_below_min)
// {
   // /** \precond
   // set sensors[0].constant.min_aliaised_range_rate  to get a  min value.
   // **/
...
*\req
*FTCP-11011 ,FTCP-8704, FTCP-8716
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_rng_rate_interval_widths_nominal)
{
   /** \precond
...
*FTCP-11011 ,FTCP-8704, FTCP-8716
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_rng_rate_interval_widths_max)
{
   /** \precond
...
// *FTCP-11011 ,FTCP-8704, FTCP-8716
// **/
// TEST(f360_tracker_trackvalidity_sanity_checks,TrackValidity_check_verification_of_sensors_rng_rate_interval_widths_above_max)
// {
   // /** \precond
...
*FTCP-11011 ,FTCP-8704, FTCP-8716
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_rng_rate_interval_widths_min)
{
   /** \precond
...
// *FTCP-11011 ,FTCP-8704, FTCP-8716
// **/
// TEST(f360_tracker_trackvalidity_sanity_checks,TrackValidity_check_verification_of_sensors_rng_rate_interval_widths_below_min)
// {
   // /** \precond
...
*\req
*FTCP-11011 ,FTCP-8735 , FTCP-9650,FTCP-8736
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_timestamp_us_nominal)
{
   /** \precond
...
*FTCP-11011 ,FTCP-8735 , FTCP-9650,FTCP-8736
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_timestamp_us_max)
{
   /** \precond
...
// *FTCP-11011 ,FTCP-8735 , FTCP-9650,FTCP-8736
// **/
// TEST(f360_tracker_trackvalidity_sanity_checks,TrackValidity_check_verification_of_sensors_timestamp_us_above_max)
// {
   // /** \precond
...
*FTCP-11011 ,FTCP-8735 , FTCP-9650,FTCP-8736
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_timestamp_us_min)
{
   /** \precond
...
// *FTCP-11011 ,FTCP-8735 , FTCP-9650,FTCP-8736
// **/
// TEST(f360_tracker_trackvalidity_sanity_checks,TrackValidity_check_verification_of_sensors_timestamp_us_below_min)
// {
   // /** \precond
...
*\req
*FTCP-11011 ,FTCP-8735 , FTCP-9650,FTCP-8733
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_number_of_valid_detections_nominal)
{
   /** \precond
...
*FTCP-11011 ,FTCP-8735 , FTCP-9650,FTCP-8733
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_number_of_valid_detections_max)
{
   /** \precond
...
// *FTCP-11011 ,FTCP-8735 , FTCP-9650,FTCP-8733
// **/
// TEST(f360_tracker_trackvalidity_sanity_checks,TrackValidity_check_verification_of_sensors_number_of_valid_detections_above_max)
// {
   // /** \precond
...
*FTCP-11011 ,FTCP-8735 , FTCP-9650,FTCP-8733
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_number_of_valid_detections_min)
{
   /** \precond
 ...
 *\req
*FTCP-11011 ,FTCP-8735 , FTCP-9650,FTCP-8731
 **/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_look_id_value_valid)
{
   /** \precond
...
// *FTCP-11011 ,FTCP-8735 , FTCP-9650,FTCP-8731
 // **/
// TEST(f360_tracker_trackvalidity_sanity_checks,TrackValidity_check_verification_of_sensors_look_id_value_wrong)
// {
   // /** \precond
...
*\req
*FTCP-11011 ,FTCP-8735 , FTCP-9650 ,FTCP-8745, FTCP-8742
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_vcs_velocity_longitudinal_nominal)
{
   /** \precond
...
*FTCP-11011 ,FTCP-8735 , FTCP-9650,FTCP-8745, FTCP-8742
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_vcs_velocity_longitudinal_max)
{
   /** \precond
...
// *FTCP-11011 ,FTCP-8735 , FTCP-9650,FTCP-8745, FTCP-8742
// **/
// TEST(f360_tracker_trackvalidity_sanity_checks,TrackValidity_check_verification_of_sensors_vcs_velocity_longitudinal_above_max)
// {
   // /** \precond
...
*FTCP-11011 ,FTCP-8735 , FTCP-9650,FTCP-8745, FTCP-8742
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_vcs_velocity_longitudinal_min)
{
   /** \precond
...
// *FTCP-11011 ,FTCP-8735 , FTCP-9650,FTCP-8745, FTCP-8742
// **/
// TEST(f360_tracker_trackvalidity_sanity_checks,TrackValidity_check_verification_of_sensors_vcs_velocity_longitudinal_below_min)
// {
   // /** \precond
...
*\req
*FTCP-11011 ,FTCP-8735 , FTCP-9650,FTCP-8745, FTCP-8743
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_vcs_velocity_lateral_nominal)
{
   /** \precond
...
*FTCP-11011 ,FTCP-8735 , FTCP-9650,FTCP-8745, FTCP-8743
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_vcs_velocity_lateral_max)
{
   /** \precond
...
// *FTCP-11011 ,FTCP-8735 , FTCP-9650,FTCP-8745, FTCP-8743
// **/
// TEST(f360_tracker_trackvalidity_sanity_checks,TrackValidity_check_verification_of_sensors_vcs_velocity_lateral_above_max)
// {
   // /** \precond
...
*FTCP-11011 ,FTCP-8735 , FTCP-9650,FTCP-8745, FTCP-8743
**/
TEST(f360_tracker_trackvalidity_sanity_checks, TrackValidity_check_verification_of_sensors_vcs_velocity_lateral_min)
{
   /** \precond
...
// *FTCP-11011 ,FTCP-8735 , FTCP-9650,FTCP-8745, FTCP-8743
// **/
// TEST(f360_tracker_trackvalidity_sanity_checks,TrackValidity_check_verification_of_sensors_vcs_velocity_lateral_below_min)
// {
   // /** \precond
