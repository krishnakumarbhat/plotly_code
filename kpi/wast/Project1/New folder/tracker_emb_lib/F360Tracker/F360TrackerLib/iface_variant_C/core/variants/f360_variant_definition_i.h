/*===================================================================================*\
* FILE: f360_variant_definition_i.h
*====================================================================================
...
*
\*==========================================================================================*/
#ifndef F360_VARIANT_DEFINITION_I_H
#define F360_VARIANT_DEFINITION_I_H

#include "f360_reuse.h"
#include "f360_variant_type.h"
namespace f360_variant_I
{
   static constexpr F360_Tracker_Variant_T VARIANT_TYPE = F360_VARIANT_TYPE_I;  // Variant type I
   static constexpr uint32_t NUMBER_OF_OBJECT_TRACKS = 100U;
