/** \file
 * This file contains unit tests for content of f360_object_track.cpp file
 */
 ...
 */
TEST(f360_object_track, FunctionToTest_Descriptive_Tag)
{
   /** \precond
