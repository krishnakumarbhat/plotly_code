/** \file
 * This file contains unit tests for content of f360_determine_dets_on_edge_of_fov.cpp file
 */
 ...
 */
TEST(f360_determine_dets_on_edge_of_fov, FunctionToTest_Descriptive_Tag)
{
   /** \precond
