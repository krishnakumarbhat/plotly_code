/** \file
 * This file contains unit tests for content of f360_get_wall_time.cpp file
 */
 ...
 */
TEST(f360_get_wall_time, FunctionToTest_Descriptive_Tag)
{
   /** \precond
