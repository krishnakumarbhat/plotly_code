#ifndef F360_TRACKER_VARIANT_A_H
#define F360_TRACKER_VARIANT_A_H
/*===================================================================================*\
* FILE: f360_tracker.h
*====================================================================================
...
namespace f360_variant_A
{
   ...
   public:
      ...
      static void Log_Detections(F360_Detection_Log_Output_T* const log, const ::RSPP_Detection_List_T &det_list);
      ...
      static void Fill_ROT_Object_Output(
         const ::RSPP_Detection_List_T& det_list,
      ...
      void Write_Debug_Info(
         ...
         const ::RSPP_Detection_List_T* const raw_detect_list,
         const F360_Radar_Sensor_T (&sensors)[MAX_NUMBER_OF_SENSORS],
