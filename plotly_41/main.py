...
class MainProcessor:
    ...
    def run(self):
        ...
        try:
            ...
            print("\nText(IN progress...) - Parsing configuration files")
            ...
            data_preparation_time = end_time_report - start_time_dataprep - report_generation_time
