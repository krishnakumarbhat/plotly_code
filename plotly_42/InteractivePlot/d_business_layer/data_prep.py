...
class DataPrep:
    ...
    def generate_plots(self):
        ...
        for signal_name, signal_config in SIGNAL_PATTERNS.items():
            ...
            data_records_in ,data_records_out  = DataRetriever.get_data(
                signal_name, 
                unique_keys,
                self.input_data,
                self.output_data,
            ...
            if (data_records_in == 'no_data_in_hdf' or data_records_out == 'no_data_in_hdf')  and 'aliases' in signal_config:
                for alias in signal_config['aliases']:
                    ...
                    if data_records_in != 'no_data_in_hdf' or data_records_out != 'no_data_in_hdf'  :
                        break
            
            if (data_records_in or data_records_out) and (data_records_in != 'no_data_in_hdf' or data_records_out != 'no_data_in_hdf'):
                ...
                for plot_type in signal_config.get('plot_types', []):
                    ...
                    if data_cal and hasattr(data_cal, func_name):
                        ...
                        fig_id, figure = getattr(data_cal, func_name)(signal_name, data_records_in,data_records_out)
                        plots[fig_id] = figure
