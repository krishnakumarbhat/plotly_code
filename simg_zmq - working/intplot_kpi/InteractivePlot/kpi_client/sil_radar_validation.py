...
def load_radar_hdf(path: Path, sensor: str) -> LoadedRadar:
    ...
    column_candidates: Mapping[str, Sequence[str]] = {
        ...
        "elevation": (f"{sensor}/DETECTION_STREAM/AF_Det/elevation", f"{sensor}/DETECTION_STREAM/AF_Det/el", "elevation", "el", "Elevation"),
        "snr": ("snr",),
        "rcs": ("rcs",),
    ...
    optional_numeric = ["snr", "rcs", "vacs_boresight_az_estimated", "timestamp", "hdrTimestamp_Sec", "hdrTimestamp_fractionalSec", "elevation"]
