...
def simulate_three_points_randomly(point_a: list, point_b: list, point_c: list, n_simulations=10000,
                                   data_path=r'private\sim_three_points_randomly_out.pickle',
    ...
    gt_polyline.add_point(point_c[0], point_c[1], point_c[2], point_c[3])
...
if __name__ == '__main__':
    simulate_three_points_randomly([4.0, -3.0, 4.0, 0.0],
                                   [4.0, -4.0, 4.0, 0.0],
                                   [5.0, -4.0, 4.0, 0.0],
                                   200000, r'private\sim_three_points_randomly_out_vel_4_2000.pickle', True)
