...
class Simulator:
    ...
    def __call__(self, i=1):
        ...
        detection, ref_points_draw = self.det_simulator.sim_single_point_randomly(self.meas_cov)
        opt_output = find_nearest_det_on_object_fast(radar_object, detection)

        opt_output = opt_output[['ref_point_x', 'ref_point_y', 'nees_value']]

        return opt_output


def simulate_object_randomly_reduced(gt_radar_object,
...
if __name__ == '__main__':
    ...
    simulate_object_randomly_reduced(gt_object,
                                     500000, r'private\single_object_x6_y5_vx4_vy0_rand_reduced_500000.pickle',
                                     True, 8)
