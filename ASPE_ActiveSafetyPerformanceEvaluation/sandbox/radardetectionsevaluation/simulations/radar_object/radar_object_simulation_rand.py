...
class Simulator:
    ...
    def __call__(self, i=1):
        ...
        detection, ref_points_draw = self.det_simulator.sim_single_point_randomly(self.meas_cov, self.meas_bias)
...
def simulate_object_randomly(gt_radar_object, meas_bias=np.zeros(3),
    ...
    sim = Simulator(gt_radar_object, pos_cov, vel_cov, meas_cov, meas_bias)
...
if __name__ == '__main__':
    ...
    simulate_object_randomly(gt_object, np.zeros(3),
                             500000, r'private\single_object_x6_y5_vx4_vy0_rand_500000.pickle',
                             True, 8)
