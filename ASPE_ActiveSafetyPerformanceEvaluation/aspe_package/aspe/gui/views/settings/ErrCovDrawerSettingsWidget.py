...
class ErrCovDrawerSettingsWidget(LinesDrawerSettingsWidget):
    ...
    def setupUi(self):
        ...
        self.sigma_label = QtWidgets.QLabel(self.drawer_setting_group_box)
        self.sigma_label.setObjectName("sigma_label")
        self.gridLayout.addWidget(self.sigma_label, 4, 0, 1, 1)
        ...
        #
        self.sigma_combo_box = QtWidgets.QComboBox(self.drawer_setting_group_box)
        self.sigma_combo_box.setObjectName("sigma_combo_box")
        self.sigma_combo_box.addItem("")
        self.sigma_combo_box.addItem("")
        self.sigma_combo_box.addItem("")
        self.gridLayout.addWidget(self.sigma_combo_box, 4, 1, 1, 1)
        #
    ...
    def retranslateUi(self):
        ...
        self.sigma_label.setText(_translate("lines_drawer_settings", "confidence"))
        ...
        self.sigma_combo_box.setItemText(0, _translate("lines_drawer_settings", "Sigma 1"))
        self.sigma_combo_box.setItemText(1, _translate("lines_drawer_settings", "Sigma 2"))
        self.sigma_combo_box.setItemText(2, _translate("lines_drawer_settings", "Sigma 3"))
    ...
    def connect_signals(self):
        ...
        self.sigma_combo_box.currentTextChanged.connect(self.on_sigma_change)

    def on_sigma_change(self):
        sigma = self.sigma_combo_box.currentText()
        confidence = confidence_dict[sigma]
        self.lines_drawer.change_confidence_interval(confidence)
    ...
    def load_state(self, state):
        ...
        confidence_interval = list(confidence_dict.keys())[list(confidence_dict.values()).index(state["confidence"])]
        ...
        self.sigma_combo_box.setCurrentText(confidence_interval)