...
class DrawerDetToClustersAssociation(DrawerLines):
    def __init__(self, parent, name: str, plot_item: pg.PlotItem, associated_data):
        super().__init__(parent, name, plot_item, "#00FA46", "--", 1)
        self.line_points = 2
    ...
    def set_data(self, data_df):
        ...
        x_1 = data_df["position_x_cluster"].apply(np.array)
        y_1 = data_df["position_y_cluster"].apply(np.array)
