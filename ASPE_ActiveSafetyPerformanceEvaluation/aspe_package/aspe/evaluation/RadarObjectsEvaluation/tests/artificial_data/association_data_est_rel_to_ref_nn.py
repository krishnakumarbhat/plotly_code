...
def get_association_data_est_rel_to_ref_nn():
    """
    ...
    est_closer_est_not_relevant = join_two_ext_data(ref_data['single_stationary_front2'],
                                                    ref_data['single_moving_front2'])
    ...
    data['closer_est_not_relevant'] = {'ref_data': ref_data['single_moving_front'],
                                       'est_data': est_closer_est_not_relevant}
