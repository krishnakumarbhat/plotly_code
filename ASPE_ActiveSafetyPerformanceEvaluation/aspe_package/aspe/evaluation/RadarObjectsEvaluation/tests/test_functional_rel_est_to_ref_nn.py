...
from aspe.evaluation.RadarObjectsEvaluation.tests.artificial_data.association_data_est_rel_to_ref_nn import \
    get_association_data_est_rel_to_ref_nn
from aspe.evaluation.RadarObjectsEvaluation.tests.artificial_data.conversions import \
    convert_test_vector_to_pytest_param
import numpy as np

relevancy_handling_data = convert_test_vector_to_pytest_param(get_association_data_est_rel_to_ref_nn())


class TestFunctionalPEPipelineRelEstToRefNN:
    ...
    def test_if_not_relevant_est_objects_are_not_associated(self, pe_pipeline_configuration, estimated_data, reference_data):
        """
        """
        # Setup
        ...
        # Verify
        relevancy_flag_est_mask = pe_output.pe_results_obj_pairs.signals['relevancy_flag_est']

        observed_all_results = pe_output.pe_results_obj_pairs.signals['is_associated'][~relevancy_flag_est_mask].any()
