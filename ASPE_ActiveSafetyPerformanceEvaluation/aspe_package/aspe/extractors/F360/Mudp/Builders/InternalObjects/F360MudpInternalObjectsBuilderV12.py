# coding=utf-8
"""
F360 MUDP internal objects builder (version 12)
"""
import typing
...
class F360MudpInternalObjectsBuilderV12(IF360MudpInternalObjectsBuilder):
    """
    ...
    """
    required_stream_definitions = {'strdef_src035_str004_ver001',
                                   'strdef_src035_str005_ver012',
                                   'strdef_src035_str007_ver001'}
    host_stream: int = 4
    ...
    def _extract_object_class_probability(self):
        ...
        mapping = {
            ...
            F360ObjectClass.MOTORCYCLE: 'probability_2wheel',
