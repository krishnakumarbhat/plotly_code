# coding=utf-8
"""
F360 MUDP objects builder (version 16)
"""
import typing
...
class F360MudpObjectsBuilderV16(IF360MudpObjectsBuilder):
    """
    supports objects extraction for stream definitions:
    ch: 6
    - strdef_src035_str006_ver016
    - strdef_src035_str006_ver017
    - strdef_src035_str006_ver018
    - strdef_src035_str006_ver019
    - strdef_src035_str006_ver020 (not tested)
    """

    required_stream_definitions = [['strdef_src035_str006_ver016', 'strdef_src035_str006_ver017',
                                    'strdef_src035_str006_ver018', 'strdef_src035_str006_ver019',
                                    'strdef_src035_str006_ver020', 'strdef_src035_str006_ver021',
                                    'strdef_src035_str006_ver022']]
    ...
    signal_mapper = {
        ...
        F360CoreSignals.tracker_id:                      'trkID',
        F360CoreSignals.status:                          'reducedStatus',
    ...
    auxiliary_signals = {
        'timestamp_us': [main_object_stream, 'object_list_timestamp'],
    ...
    def _extract_motion_model_state(self) -> None:
        ...
        pos_x = self._raw_signals['vcs_xposn']
        vel_x = self._raw_signals['vcs_xposn']
        acc_x = self._raw_signals['vcs_xaccel']
        pos_y = self._raw_signals['vcs_yposn']
        vel_y = self._raw_signals['vcs_yvel']
        acc_y = self._raw_signals['vcs_yaccel']
        ...
        _fill_motion_model_state_suppl(ccv_mask, (pos_x, vel_x, acc_x, pos_y, vel_y, acc_y))
        _fill_motion_model_state_suppl(ctca_mask, (pos_x, pos_y, heading, curvature, speed, tang_accel))
