# coding=utf-8
"""
F360 MUDP objects builder (version 13)
"""
import typing
...
class F360MudpObjectsBuilderV13(IF360MudpObjectsBuilder):
    """
    supports objects extraction for stream definitions:
    ch: 4 - strdef_src035_str004_ver001.txt
    ch: 6 - strdef_src035_str006_ver013.txt
    ch: 7 - strdef_src035_str007_ver001.txt
    """
    required_stream_definitions = {'strdef_src035_str004_ver001', 'strdef_src035_str006_ver013',
