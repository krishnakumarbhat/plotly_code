# coding=utf-8
"""
F360 MUDP execution time info builder (version 12)
"""
...
class F360MudpExecutionTimeInfoBuilderV12(IF360MudpExecutionTimeInfoBuilder):
    """
    supports objects extraction for stream definitions:
    ch: 9
        - strdef_src035_str009_ver012.txt
        - strdef_src035_str009_ver013.txt
        - strdef_src035_str009_ver014.txt (not tested)
    """
    required_stream_definitions = {'strdef_src035_str009_ver012', 'strdef_src035_str009_ver013',
                                   'strdef_src035_str009_ver014'}
    main_stream = 9
    signal_mapper = {
        # ASPE signature                  F360 signature
        GeneralSignals.scan_index:       'tracker_index',
