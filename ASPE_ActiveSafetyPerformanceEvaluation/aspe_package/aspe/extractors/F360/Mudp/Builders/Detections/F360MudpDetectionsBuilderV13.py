# coding=utf-8
"""
F360 MUDP detections builder (version 13)
"""
...
class F360MudpDetectionsBuilderV13(IF360MudpDetectionsBuilder):
    """
    ...
    """
    required_stream_definitions = {'strdef_src035_str003_ver013', 'strdef_src035_str007_ver001'}
    main_stream = 3
    ...
    signal_mapper = {
        ...
        'sensor_id':            'sensorID',
        'range_rate':           'rngrate_dealiased',
        'position_x':           'vcs_x',
        'position_y':           'vcs_y',
        'raw_det_id':           'raw_det_id',
        'assigned_obj_id':      'objTrkID',
        'cluster_id':           'clusterID',
        'range_rate_comp':      'rngrate_comp',
        'range_rate_dealiased': 'rngrate_dealiased',
        'motion_status':        'motion_status',
        'wheel_spin_status':    'wheel_spin',
        'f_dealiased':          'f_dealiased',
    }
    auxiliary_signals = {
        'scan_index': [tracker_info_stream, 'tracker_index'],
        'sensor_timestamps': [main_stream, 'sensorInfoLog', 'timestamp'],
