# coding=utf-8
"""
F360 MUDP host builder (version 3)
"""
...
class F360MudpHostBuilderV3(IF360MudpHostBuilder):
    """
    supports host extraction for stream definitions:
    ch: 4
        - strdef_src035_str004_ver003
        - strdef_src035_str004_ver004
        - strdef_src035_str004_ver005
        - strdef_src035_str004_ver006
    """
    required_stream_definitions = [['strdef_src035_str004_ver003', 'strdef_src035_str004_ver004',
                                    'strdef_src035_str004_ver005', 'strdef_src035_str004_ver006']]
    main_stream = 4
    signal_mapper = {
    ...
    properties = {
        'dist_of_rear_axle_to_front_bumper': [main_stream, 'dist_rear_axle_to_vcs_m'],
    }
