...
class F360MudpOALObjectsBuilderStream17V5(IF360MudpObjectsBuilder):
    ...
    obj_list_map = ['parsed_data', 17, 'adapted_output', 'bmw_object_list', 'object_list']

    signal_mapper = {
        #ASPE signature                               # BWM signature
        GeneralSignals.id:                            'summary_id',
        ...
        PhysicalSignals.velocity_otg_x:               'dynamics_velocity_absolute_x',
        PhysicalSignals.velocity_otg_y:               'dynamics_velocity_absolute_y',
        PhysicalSignals.velocity_rel_x:               'dynamics_velocity_relative_x',
        PhysicalSignals.velocity_rel_y:               'dynamics_velocity_relative_y',
        PhysicalSignals.velocity_otg_covariance:      'dynamics_velocity_absolute_covariance_xy',
        PhysicalSignals.acceleration_otg_x:           'dynamics_acceleration_absolute_x',
        PhysicalSignals.acceleration_otg_y:           'dynamics_acceleration_absolute_y',
        PhysicalSignals.acceleration_otg_covariance:  'dynamics_acceleration_absolute_covariance_xy',
        PhysicalSignals.yaw_rate:                     'dynamics_orientation_rate_mean',
        PhysicalSignals.bounding_box_dimensions_x:    'shape_length_edge_mean',
        PhysicalSignals.bounding_box_dimensions_y:    'shape_width_edge_mean',
        PhysicalSignals.bounding_box_orientation:     'position_orientation',
        GeneralSignals.existence_indicator:           'existence_existence_probability',
    ...
    def build(self):
        ...
        self._object_signals_flat, _ = recursive_dict_extraction(obj_list, keys_to_skip='UNUSED')
