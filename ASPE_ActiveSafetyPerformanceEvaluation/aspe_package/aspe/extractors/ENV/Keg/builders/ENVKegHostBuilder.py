...
from aspe.extractors.ENV.DataSets.ENVHost import ENVHost
...
class ENVKegHostBuilder(ENVKegBuilder):
    """
    supports host extraction from .keg file
    """
    signal_mapper = {
    ...
    properties = {
        'dist_of_rear_axle_to_front_bumper': ['VEHICLE', 'host_calib', 'dist_rear_axle_to_vcs_m'],
    }
    ...
    def _set_parsed_data_shape(self):
        ...
        """
        raw_speed = get_nested_array(self._parsed_data, ['VEHICLE', 'host', 'speed'])
    ...
    def _extract_raw_signals(self):
        ...
        :return:
        """
        host_signals = self._parsed_data['VEHICLE']

        for value in host_signals.values():
            for raw_signal_name, raw_signal_values in value.items():
    ...
    def _extract_scan_index(self):
        ...
        if scan_index is None:
            ...
            scan_index = np.arange(self._parsed_data_shape)
    ...
    def _extract_timestamps(self):
        self.data_set.signals["timestamp"] = self._timestamps
