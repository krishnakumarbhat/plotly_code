...
# Some datasets are produced in dedicated RDD-dump HDFs where the stream group name is different
# from DETECTION_STREAM. Mirror the minimal configuration so the parser will traverse those groups
# and DataPrep can generate plots.
Gen7V1_V2.setdefault(
    "RDD_STREAM",
    {
...
# Some RDD dumps use lowercase stream naming; accept those too.
Gen7V1_V2.setdefault("rdd_stream", Gen7V1_V2["RDD_STREAM"])
