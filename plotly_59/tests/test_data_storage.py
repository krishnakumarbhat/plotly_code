...
# from InteractivePlot.c_data_storage.regex_storage import RegexStorage
...
# def test_regex_storage_add_and_match():
#     regex_storage = RegexStorage()
#     regex_storage.add_regex("test_pattern", "^test$")
#     assert regex_storage.match_string("test_pattern", "test") is True
#     assert regex_storage.match_string("test_pattern", "testing") is False