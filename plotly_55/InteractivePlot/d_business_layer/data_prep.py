...
class DataPrep:
    ...
    def __init__(self, input_data, output_data, html_name, output_dir=None, stream_name='Radar', generate_html=True):
        """
        ...
        self.data_storage = {}  # Temporary storage for plot data
        ...
        # Generate plot data dictionary and then create plots based on sequence
    ...
    def _get_data_cached(self, signal_name, keys_tuple):
        ...
        Returns:
        - Tuple (data_records, data_dict) from DataRetriever.get_data or ('no_data_in_hdf', {}) if not found
        """
    ...
    def _prepare_data_dict(self, unique_keys):
        ...
        for scan_idx in unique_keys:
            input_row = self.input_data.get(scan_idx, [])
            output_row = self.output_data.get(scan_idx, [])
    ...
    def generate_plots(self):
        ...
        for signal_name, signal_config in Gen7V1_v2.items():
            mp_args.append((signal_name, signal_config, data_cal))
        ...
        # Store the data
        self.data_storage = signal_plot_data
        ...
        for plot_key in sequance_of_plot:
            if plot_key in signal_plot_data:
                plots_hash[self.stream_name].append(signal_plot_data[plot_key])
