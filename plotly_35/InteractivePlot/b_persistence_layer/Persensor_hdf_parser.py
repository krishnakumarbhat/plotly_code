    ...
    def parse(self):
        ...
        for input_file, output_file in self.address_map.items():
            ...
            with h5py.File(output_file, 'r') as hdf_file_out:
                ...
                self.data_container_out, self.val_sig_map_out ,self.sig_val_map_out  = hdf_parser.HDF5Parser.parse(data_group, self.data_container_out, self.val_sig_map_out,self.sig_val_map_out ,scan_index)
