...
class RuntimeBroker:
    ...
    def _tool_command(
        ...
        launcher_path = self.workspace_root / 'simg_sh_hpcc' / 'kpi_runtime_launcher.sh'
        ...
        if tool_key in {'can_kpi', 'udp_kpi'} and interactive_plot_mode == 'enabled':
            ...
            if input_mode == 'hdf':
                ...
                return _script_command(launcher_path, launcher_args), input_mode, input_hdf
            ...
            return _script_command(launcher_path, launcher_args), input_mode, json_path
        ...
        if tool_key == 'interactive_plot':
            ...
            return _script_command(launcher_path, launcher_args), input_mode, inputs_json
        ...
        if image_path is not None:
            ...
            return _container_run_command(image_path, command_args, env_overrides, bind_paths), default_mode, primary_input
