...
class KpiDataModel:
    def __init__(self, input_data, output_data):
        ...
        self.plots = self.create_html(input_data, output_data)

    def create_html(self, input_data, output_data):
        """
        ...
        scatter_plot = KpiVisualization.kpi_scatter_plot(
            data_records, signal_name="Detection Matching", sensor_position="KPI"
        )
