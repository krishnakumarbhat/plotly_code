...
class DataCalculations:
    ...
    def create_diff_box_plot(self, signal_name, data_records):
        """
        ...
        common_indices = set(input_map.keys()) & set(output_map.keys())
    ...
    def create_diff_scatter_plot(self, signal_name, data_records):
        """
    ...
    def histogram_with_count(self, signal_name, data_records):
        """
